...
<a
href="notifications.php?read=<?php echo $notification['notification_id']; ?>&go=<?php echo urlencode($notification['link']); ?>"
class="view-btn">
View
</a>
...
<a
href="notifications.php?delete=<?php echo $notification['notification_id']; ?>"
class="delete-btn"
